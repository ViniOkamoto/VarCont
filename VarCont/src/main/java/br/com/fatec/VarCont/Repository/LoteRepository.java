...
public interface LoteRepository extends JpaRepository<Lote, Long>{
	...
	@Query(value = "select  tl.prod_id ,tp.prod_nome ,SUM(lote_qtd_total) total FROM tbl_lote tl JOIN tbl_produto tp ON tl.prod_id = tp.prod_id  group by prod_id", nativeQuery = true)
